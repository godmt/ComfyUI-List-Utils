...
NODE_CLASS_MAPPINGS = {
    ...
    "StringListSelectByIndex": StringListSelectByIndex,
    "ListSelectByIndex": ListSelectByIndex,
    "BatchSelectByIndex": BatchSelectByIndex,
    "StringListSlice": StringListSlice,
    "ListSlice": ListSlice,
    "BatchSlice": BatchSlice,
    "BatchToStringList": BatchToStringList,
    "StringListToBatch": StringListToBatch,
